import fs from 'fs';
import type { ResponseLike } from 'hubspot-account-info/internal/to-file';
import { toFile } from 'hubspot-account-info/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('hubspot-account-info/core/uploads');
    await expect(
